...
const ALL_ITEMS: NavItem[] = [
  ...
  { title: 'Departments', url: '/departments', icon: 'building-2' },
  { title: 'Rooms & Equipment', url: '/rooms', icon: 'door-open' },
